...
$("#cargar_tabla").load("<?php echo base_url(); ?>index.php/Unload/listarEntradas");
...
function guardar(){
 ...
 // Create an FormData object
  ...
  $.ajax({
      ...
      // cache: false,
      //dataType: 'JSON',
      url: 'index.php/Unload/guardar',
      success: function(result) {

        $("#cargar_tabla").load("<?php echo base_url(); ?>index.php/Unload/listarSalidas");
