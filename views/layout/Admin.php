    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar" style="height: auto;">
            ...
            <li class="treeview"><a href="#">
              <i class="fa fa-share"></i> <span>Pañol</span>
              ...
              <ul class='treeview-menu'>
                ...
                <li class='treeview'><a href='#' onclick='linkTo("Herramienta/index")'><i class='fa fa-circle-o'></i>Herramienta</a></li>

                <li class='treeview'><a href='#' onclick='linkTo("Order/index")'><i class='fa fa-circle-o'></i>Salida Herramientas</a></li>

                <li class='treeview'><a href='#' onclick='linkTo("Unload/index")'><i class='fa fa-circle-o'></i>Entrada Herramientas</a></li>

                <li class='treeview'><a href='#' onclick='linkTo("Trazacomp/index")'><i class='fa fa-circle-o'></i>Trazabilidad Componentes</a></li>

                <li class='treeview'><a href='#' onclick='linkTo("Plantilla/index")'><i class='fa fa-circle-o'></i>Plantilla</a></li>
